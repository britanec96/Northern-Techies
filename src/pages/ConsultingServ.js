    ...
    <>
      <section className="relative bg-cover bg-center bg-almost-black">
        ...
        <div className="relative z-10 max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
          <div className="lg:grid lg:grid-cols-2 lg:gap-8">
            <motion.div
              className="max-w-md mx-0 flex flex-col justify-start text-left"
          ...
          <div className="flex justify-between mt-12">
            <motion.p
              className="text-almost-white font-bold text-xl mt-7"
              variants={animationVariants}
              initial="hidden"
              whileInView="visible"
              viewport={{ once: false }}
      ...
      <section className="p-12 bg-gray-900">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <motion.p
            className="text-lg md:text-xl text-gray-300 mb-10 opacity-80"
            variants={animationVariants}
            initial="hidden"
            whileInView="visible"
            viewport={{ once: false }}
      ...
      <section className="bg-gray-900 p-5 my-5 text-center relative">
        <motion.h1
          className="m-5 text-almost-white text-3xl md:text-5xl font-extrabold"
          variants={animationVariants}
          initial="hidden"
          whileInView="visible"
          viewport={{ once: false }}
