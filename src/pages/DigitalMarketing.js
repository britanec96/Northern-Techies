  ...
  >
    ...
    Chat with us on Telegram
        ...
        <div className="flex justify-between mt-12">
          <p className="text-almost-white font-bold text-xl mt-7 element-delay-400">We work with the most popular social media:</p>
          <div className="flex flex-col md:flex-row xl:flex-row md:space-x-8 space-y-3">
          <img className='mt-3 element-delay-400' src={Tiktok} alt="TiktokIcon" loading="lazy" />
          <img className='element-delay-400' src={Instagram} alt="Instagram" loading="lazy"/>
          <img className='element-delay-400' src={Facebook} alt="JavaScript" loading="lazy" />
          </div>
        </div>
      </div>
    </section>
    ...
    <section>
        <div className='bg-gray-900 p-5 text-center relative'>
         <h1 className='m-5 text-almost-white text-6xl font-extrabold element-delay-400'>Are you ready to go viral?</h1>
    ...
    <img className="w-1/2 h-auto m-10 element-delay-400" src={MarketingIcon} alt="Web Icon" loading="lazy" />
          <h1 className='font-bold text-lg text-almost-white element-delay-400'>What is Digital Marketing?</h1>
          <p className='m-5 text-gray-300 element-delay-400'>Digital marketing for social media involves creating and implementing strategies to promote brands, products, or services across social media platforms. Digital marketers use various tools, techniques, and content—such as posts, ads, videos, and stories—to engage target audiences, increase brand visibility, and drive user interaction.</p>
        </div>
        <div className='flex flex-col items-center'>
        <img className="w-1/2 h-auto m-10 element-delay-400" src={WhyChooseUsIcon} alt="Web Icon" loading="lazy" />
        <h1 className='font-bold text-lg text-almost-white element-delay-400'>Why Choose Us for Boost you Social?</h1>
          <p className='m-5 text-gray-300 element-delay-400'>We bring a mix of creativity, strategic expertise, and personalized solutions to craft digital marketing campaigns that engage and convert. Our team specializes in building targeted, data-driven social media strategies and content that boost brand visibility, foster customer relationships, and drive measurable results. </p>
        </div>
      </div>
      </section>
      </Wrapper>
